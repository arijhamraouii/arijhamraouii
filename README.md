...
### Computer Science Engineering Student | Full-Stack Developer | Innovation Enthusiast

*"Every challenge is an opportunity to grow, every line of code a chance to create."*

[![Email](https://img.shields.io/badge/Email-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:arij.hamraoui.pro@gmail.com)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/arij-hamraoui)
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/arijhamraouii)
...
<img align="right" alt="Programmer Girl" width="400" src="https://i.pinimg.com/originals/f0/4d/f6/f04df61adc69ea2013efb1e0d3e1ab0c.gif">
...
|:---:|:---:|
| **Institution:** TEK-UP University (In Progress : 1st Year) | **Institution:** ISET Charguia (Graduated) |
...
**🛠️ Tech Stack:** `Spring Boot` • `Angular` • `MySQL` • `REST API`

**✨ Key Features:** Microservices Architecture • Secure Transactions • Real-time Operations
...
**🛠️ Tech Stack:** `Spring Boot` • `Node.js` • `MongoDB` • `Microservices`

**✨ Key Features:** Distributed System • Order Tracking • Scalable Infrastructure

---

### 🌍 **Oasis**
*AI-powered platform centralizing scholarship opportunities with intelligent web scraping*

**🛠️ Tech Stack:** `Python` • `Django` • `Machine Learning` • `Web Scraping`

**✨ Key Features:** AI Data Collection • Smart Recommendations • Centralized Hub

---

### 📚 **Prepa Du Prepa**
*Comprehensive web application for engineering entrance exam preparation*

**🛠️ Tech Stack:** `Angular` • `Spring Boot` • `PostgreSQL` • `REST API`

**✨ Key Features:** Interactive Modules • Progress Tracking • Practice Exams
...
[![Email](https://img.shields.io/badge/📧-E_mail_Me-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:arij.hamraoui.pro@gmail.com)
...
### ✨ *"Always seeking learning and innovation - one commit at a time!"* ✨
